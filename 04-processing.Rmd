...
```{r, echo = F, fig.cap="Criteria to replace null imports or exports"}
knitr::include_graphics("fig/clean-data.svg")
```
...
```{r, echo = F, fig.cap="Schematic of the procedure used to determine the countries that were included in the Atlas"}
